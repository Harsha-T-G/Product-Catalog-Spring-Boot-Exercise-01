...
description: Test-driven development for Product Catalog. Self-contained vendored skill with Maven and Spring Boot test conventions.
---
...
| API integration tests | `@SpringBootTest` + `MockMvc` + `PostgreSqlTestSupport` |
| Test profile | `@ActiveProfiles("test")` |
| Test naming | Given-When-Then; `// Arrange`, `// Act`, `// Assert` |

Also read `AGENTS.md`, `.guidelines/java.md`, and `.guidelines/spring-boot.md`.
