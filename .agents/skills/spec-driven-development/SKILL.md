...
description: Creates specs before coding for Product Catalog. Self-contained vendored skill with repository path overrides.
---
...
| Generic build/test | `./mvnw clean verify`, `./mvnw test` |

Stop for human approval after Specify, Plan, and Tasks. Do not implement behavior not in the approved spec.
